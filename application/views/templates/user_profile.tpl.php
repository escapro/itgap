	...
	<div class="block page-right_block">
		<form class="user-form" action="#">
			<div class="form-field mb-2">
				...
				<input class="form-input" id="form1" type="text" placeholder="Ваше имя">
			</div>
			<div class="form-field mb-2">
				<label class="form-label" for="form1">Имя пользователя</label>
				<input class="form-input" id="form1" type="text" placeholder="Имя пользователя" value="admin">
			</div>
			<div class="form-field mb-2">
				<label class="form-label" for="form2">Email</label>
				<input class="form-input" id="form2" type="email" placeholder="Ваш email адрес" value="ruslan-19_97@mail.ru">
			</div>
			<div class="form-field mb-2">
				<label class="form-label" for="form3">Город</label>
				<input class="form-input" id="form3" type="text" placeholder="Где вы живёте?">
			</div>
			<div class="form-field mb-2">
